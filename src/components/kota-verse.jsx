export const KotaverseCta = () => {
  return (
    <section className="KotaverseCta_kotaverseCta__bBpWa">
      <div className="DarkThemeSwitch_cover__hn_xc"></div>
      <div className="KotaverseCta_text__IMtZr">
        <p className="KotaverseCta_smallHeading__2lBEA">Celebrating 12 years</p>
        <div className="Marquee_marquee__ALmrA">
          <div class="Marquee_inner__fvYgL">
            <figure class="KotaverseCta_marquee__PNczk">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 882.26 105.71"
              >
                <defs>
                  <linearGradient
                    id="f"
                  ...
                  >
                    <stop offset="0" stop-color="#7146f2"></stop>
                    <stop offset="1" stop-color="#ff83ff"></stop>
                  </linearGradient>
                </defs>
                <g>
                  <g stroke-width="0">
          ...
          <div className="Marquee_inner__fvYgL">
            <figure className="KotaverseCta_marquee__PNczk">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 882.26 105.71"
              >
                <defs>
                  <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop offset="0" stopColor="#7146f2"></stop>
                    <stop offset="1" stopColor="#ff83ff"></stop>
                  </linearGradient>
                </defs>
                <g>
                  <g strokeWidth="0">
                    <path
                      fill="#fff"
                      d="M628.76 105.7c-5.7.04-11.37-.75-16.83-2.36a41.84 41.84 0 01-13.7-6.95c-8.2-6.39-12.89-15.66-13.57-26.81h12.8c1.15 11.29 7.52 24.75 31.3 24.75 8.22 0 14.46-1.75 18.57-5.19 3.52-2.99 5.48-7.42 5.33-12.03 0-14.04-7.79-16.56-30.3-21.76-7.44-1.74-15.92-3.95-22.42-8.22-7.41-4.85-11.01-11.52-11.01-20.38 0-8.03 3.11-14.74 9-19.4a31.7 31.7 0 0110.92-5.43C613.71.59 618.74-.06 623.78 0c5.04-.05 10.05.64 14.88 2.06 4.29 1.26 8.29 3.34 11.79 6.12 3.38 2.73 6.13 6.17 8.05 10.07 2.1 4.36 3.35 9.07 3.68 13.9h-12.8c-1.92-14.17-10.06-20.77-25.61-20.77-13.8 0-22.05 5.21-22.05 13.94 0 12.74 9.8 15.13 23.35 18.44l.43.1c.69.17 1.39.34 2.1.52 11.18 2.78 20.84 5.18 27.51 9.8 3.29 2.2 5.93 5.25 7.64 8.83 1.81 3.82 2.69 8.43 2.69 14.09.02 3.68-.7 7.32-2.11 10.71-1.48 3.5-3.73 6.62-6.58 9.14a32.025 32.025 0 01-11.41 6.36 53.315 53.315 0 01-16.59 2.4z"
                    ></path>
                  </g>
                </g>
              </svg>
        ...
        <div className="Magnetic_magnetic__LncOy" data-fill="false">
          ...
          >
            <a
              ...
              className="Button_inner__fnyH6"
              target="_blank"
            >
              <span className="Button_border__hirH2"></span>
              <span className="Button_text__IZaCD">
                <span className="Button_textInner__JTTHe">Explore</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <figure className="KotaverseCta_backgroundVideo__FSZyH">
        <span className="Parallax_container__O28WA" data-fill="true">
          <span
            className="Parallax_containerInner__yaEn0"
            data-fill="true"
            style={{
              transform: "translate(0%, -19.7177%) translate3d(0px, 0px, 0px)",
            }}
          >
            <span className="AutoplayVideo_video__zckWy AutoplayVideo_fill__ZPgCR">
              <video loop playsInline>
                <source
                  src="https://kota-content.b-cdn.net/app/uploads/2024/01/blob-loop-uncompressed_1706098182.mp4"
                  type="video/mp4"
                />
              </video>
            </span>
